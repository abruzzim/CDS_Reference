...
var Reveal = (function(){
	...
	function addEventListeners() {
		...
		if ( config.progress && dom.progress ) {
            ...
            // Edited by Jeremy - Event Listener Patch taken from reveal.js GitHub issue #323
...
//	}
	...
	function availableRoutes() {
		...
		return {
            ...
            // Edited by Jeremy: Preventing horizontal change when vertical is not 0
			left: ((indexh > 0)&&(indexv == 0)),
			right: ((indexh < horizontalSlides.length - 1)&&(indexv==0)),
			up: indexv > 0,
	...
	function navigateLeft() {
        ...
        // Edited by Jeremy: Horizontal change not allowed if vertical is not 0
