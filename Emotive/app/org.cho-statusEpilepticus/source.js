$(document).ready(function() {
    ...
    Emotive.Data =
    {
        ...
        timerState: 0,
        timerIntervals: [
            {"VS":true,"Neu":true,"IVF":true,"Labs":true,"Abx":true,"Glu":false},
            {"VS":true,"Neu":true,"IVF":false,"Labs":false,"Abx":false,"Glu":false},
            {"VS":true,"Neu":true,"IVF":false,"Labs":false,"Abx":false,"Glu":true},
            {"VS":true,"Neu":true,"IVF":false,"Labs":false,"Abx":false,"Glu":false},
            {"VS":true,"Neu":true,"IVF":false,"Labs":false,"Abx":false,"Glu":false},
            {"VS":true,"Neu":true,"IVF":false,"Labs":false,"Abx":false,"Glu":false},
            {"VS":true,"Neu":true,"IVF":false,"Labs":false,"Abx":false,"Glu":true}
    ...
    $(".gcsModalLaunch").click(function(event) {
        $('#comaModal').modal();
    });

    $('#comaModal').on('shown', function () {
