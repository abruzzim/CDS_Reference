...
function CDF_Ready() {
    ...
    Emotive.Data =
    {
        ...
        timerState: 0,
        timerIntervals: [
            {"VS":true,"Neu":true,"Glu":true,"Na":true},
            {"VS":true,"Neu":true,"Glu":false,"Na":false},
            {"VS":true,"Neu":true,"Glu":false,"Na":false},
            {"VS":true,"Neu":true,"Glu":false,"Na":false}
        ],
    ...
    // Modal-specific JS
    $(".bpModalLaunch").click(function(event) {
        $('#lookupModal').modal();
    });
    ...
    $('#comaModal, #lookupModal').on('shown', function () {
    ...
    $('#comaModal, #lookupModal').on('hidden', function () {
        if (Emotive.Data.state == 'home')
        {
            if (!Emotive.Data.eventListeners)
            {
